        ...
        try {
            ...
            foreach ($collection as $item) {
                if ($item[0] === null || $item[1] === null || $item[2] === null || $item[3] === null || $item[4] === null 
                    || $item[5] === null || $item[6] === null || $item[7] === null || $item[8] === null || $item[9] === null) {
                    continue;
                }

                $quantity_up = is_numeric($item[5]) ? $item[5] : 0;
                $quantity_down = is_numeric($item[8]) ? $item[8] : 0;
                ...
                $paper_down->quantity = $quantity_down;
