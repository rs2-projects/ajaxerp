...
return new class extends Migration
{
    ...
    {
        Schema::create('pre_production_material_deliveries', function (Blueprint $table) {
            $table->id();
            ...
            //define foreign keys
            $table->foreign('pre_production_id', 'ppmd_pp_id')->references('id')->on('pre_productions');
        });
    }
    ...
    {
        Schema::dropIfExists('pre_production_material_deliveries');
    }
};
