...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pre_production_process_boards', function (Blueprint $table) {
            ...
            //define foreign keys
            $table->foreign('pre_production_id', 'ppp_boards_pp_id')->references('id')->on('pre_productions');
            $table->foreign('pre_production_process_id', 'ppp_boards_ppp_id')->references('id')->on('pre_production_processes');
            $table->foreign('finished_board_category_id', 'ppp_boards_pmc_id')->references('id')->on('finished_goods_categories');
            $table->foreign('finished_board_id', 'ppp_boards_pm_id')->references('id')->on('finished_goods');
        });
    }
