...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('pre_production_material_delivery_details_items', function (Blueprint $table) {
            $table->unsignedInteger('quantity')->default(0)->after('product_material_purchase_details_id');
            ...
            DB::select("ALTER TABLE `pre_production_material_delivery_details_items` CHANGE `barcode` `barcode` VARCHAR(64);");
        });
    }
