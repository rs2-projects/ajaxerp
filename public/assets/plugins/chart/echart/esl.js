...
!(function (n) {
        ...
        if (e && !l(n, B)) {
            ...
            $(t, function (t, r) {
                var a,
                    ...
                    c = q(f.mod, n);
                c && !P[c]
                    ? (f.res && ((u = { id: t, mod: c, res: f.res }), (F[c] = 1), e.depPMs.push(c), e.depRs.push(u)), (a = e.depMkv[c]), a || ((a = { id: f.mod, absId: c, hard: i > r }), e.depMs.push(a), (e.depMkv[c] = a), o.push(c)))
                    : (a = { absId: c }),
    ...
    var D,
        ...
        _ = w(),
        C = { baseUrl: "./", paths: {}, config: {}, map: {}, packages: [], waitSeconds: 0, noRequests: {}, urlArgs: {} };
