        ...
        @if(hasPermission('manage-employee-termination'))
            <div class="erp-add-employee-wrapper mb-3">
                <div class="erp-add-employee">
                    <a href="javascript:void(0)" class="btn add-btn erp-add-employee" data-bs-toggle="modal" data-bs-target="#add_user_termination_modal"><i class="fa-solid fa-plus"></i> Add Termination</a>
                </div>
            </div>
        @endif
...
@section('modals')
    @include('hr.user-termination._add_user_termination_modal')
    @include('hr.user-termination._edit_user_termination_modal')
@endsection
...
@section('js')
    <script>
        ...
        function getData(){
            getPaginatedListData("{{ route('hr.user-termination.filtered') }}", "#ajax-data-load");
        }
