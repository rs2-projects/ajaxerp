...
<div id="addBoardsModal" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ route('inventory.boards.store') }}" id="finishedGoodsStoreForm" enctype="multipart/form-data" method="post">
                @csrf
                <div class="modal-header erp-modal-header">
                    <h5 class="modal-title">Add New Boards</h5>
