        ...
        <div class="col-md-12">
            <div class="new-warhouse-wrapper">
                <div class="row justify-content-center">
                    <form action="{{ route('inventory.finished-good.update',$finished_good->id) }}" id="productMaterialUpdateForm" enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="col-md-12">
                                        ...
                                        <div class="erp-filter-item-wrapper filter-row d-flex flex-wrap align-items-center justify-content-between mb-3 ">
                                            ...
                                            <div class="erp-filter-item flex-48">
                                                <div class="input-block erp-step-input-block mb-0 two">
                                                    ...
                                                    <select class="select select-step" name="finished_goods_category_id" required>
                                                        <option value="">Select Category</option>
                                                        @foreach($finished_goods_categories as $category)
                                        ...
                                        <div class="erp-filter-item-wrapper filter-row d-flex flex-wrap align-items-center justify-content-between mb-3 ">
                                            <div class="erp-filter-item flex-100">
                                                <div class="input-block mb-0 erp-step-input-block ">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ $finished_good->working_temperature}}" name="working_temperature">
                                                </div>
                                            </div>
                                            <div class="messurement-wrapper flex-100 d-flex flex-wrap justify-content-between">
                                                ...
                                                <div class="erp-filter-item flex-32">
                                                    <div class="input-block mb-0 erp-step-input-block ">
                                                        ...
                                                        <input type="text" class="form-control " value="{{ $finished_good->length }}" name="length">
                                                    </div>
                                                </div>
                                                <div class="erp-filter-item flex-32">
                                                    <div class="input-block mb-0 erp-step-input-block ">
                                                        <label class="col-form-label">Width </label>
                                                        <input type="text" class="form-control " value="{{ $finished_good->width }}" name="width">
                                                    </div>
                                                </div>
                                                <div class="erp-filter-item flex-32">
                                                    <div class="input-block mb-0 erp-step-input-block ">
                                                        <label class="col-form-label">Thickness </label>
                                                        <input type="text" class="form-control " value="{{ $finished_good->thickness }}" name="thickness">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="erp-filter-item flex-100">
                                                <div class="input-block mb-0 erp-step-input-block ">
                                                    ...
                                                    <input type="text" class="form-control " value="{{ $finished_good->remarks }}" name="remarks">
                                                </div>
                                            </div>
                                        ...
                                        <div class="erp-filter-item-wrapper filter-row d-flex flex-wrap align-items-center justify-content-between mb-3 ">
                                                ...
                                                <div class="input-block erp-step-input-block mb-0 two">
                                                    ...
                                                    <select class="select select-step" name="warehouse_id" id="warehouse_id" onchange="changeWarehouse(this)" required>
                                                        ...
                                                        @foreach($warehouses as $warehouse)
                                                            <option value="{{ $warehouse->id }}" {{ ($finished_good->warehouse_id == $warehouse->id) ? 'selected' : ''}}>{{ $warehouse->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="input-block erp-step-input-block mb-0">
                                                    ...
                                                    <select class="racks-multiselect racks" multiple="multiple" name="racks[]" id="racks_id" required>
                                                        @foreach($racks as $rack)
                                                            <option value="{{ $rack->id }}" {{ in_array($rack->id, $finished_goods_racks) ? 'selected' : '' }}>{{ $rack->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="erp-filter-item flex-100">
                                                <div class="input-block mb-0 erp-step-input-block ">
                                                    ...
                                                    <input type="text" class="form-control " value="{{ $finished_good->comments }}" name="comments">
                                                </div>
                                            </div>
