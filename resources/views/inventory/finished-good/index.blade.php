                    ...
                    <div class="my-attendance-report-wrapper">
                        <div class="erp-header-main-wrap d-flex justify-content-between align-items-center">
                            <div class="erp-box-header">
                                <h4>Total Product : <span class="total-material-product" id="total_product">{{ $total_goods }}</span> </h4>
                            </div>
...
@section('js')
    <script>
        ...
        function changeWarehouse(select){
            ...
            let url = "{{ route('inventory.finished-good.get-sections-by-warehouse') }}";
        ...
        function changeSections(select){
            ...
            let url = "{{ route('inventory.finished-good.get-racks-by-sections') }}";
        ...
        /*function editItem(id){
            let url = "{{route('inventory.finished-good.edit', ':id')}}";
