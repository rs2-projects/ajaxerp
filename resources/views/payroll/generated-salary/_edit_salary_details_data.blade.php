        ...
        <div class="col-sm-6">
            <div>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td><strong>Total Deductions</strong> <span class="float-right"><span class="currency-text">{{ getCurrencySymbol() }}</span><strong id="total_deduction_text"> {{ formatNumber(showAmount($total_deduction)) }} </strong></span></td>
                    </tr>
