<div class="">
    <table class="table mb-0 erp-table">
        ...
        <tbody class="erp-tbody">
            @foreach($requested_info as $pr)
                <tr class="erp-tbody-tr">
                    <td class="erp-tbody-td">
                        <h4 class="d-table-title">{{ $requested_info->firstItem() + $loop->iteration -1 }}</h4>
                    </td>
...
{{ $requested_info->links('vendor.pagination.common_ajax_pagination') }}
