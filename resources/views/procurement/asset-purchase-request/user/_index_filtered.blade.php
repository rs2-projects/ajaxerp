<div class="">
    <table class="table mb-0 erp-table">
        ...
        <tbody class="erp-tbody">
            @foreach($all_requests as $pr)
                <tr class="erp-tbody-tr">
                    <td class="erp-tbody-td">
                        <h4 class="d-table-title">{{ $all_requests->firstItem() + $loop->iteration -1 }}</h4>
                    </td>
                            ...
                            <div class="erp-action-t">
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="javascript:void(0)" onclick="deleteAjax('{{ route('procurement.user.asset-purchase-request.delete',$supplier->id) }}', 'reloadAjaxGetData') "><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
                                    </div>
                                </div>
                            </div>
                        @endif
...
{{ $all_requests->links('vendor.pagination.common_ajax_pagination') }}
