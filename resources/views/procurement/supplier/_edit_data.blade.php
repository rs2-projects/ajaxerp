                                            ...
                                            <div class="erp-deduction-wrapper position-relative filter-row mb-3 d-flex flex-wrap align-items-center justify-content-between">
                                                ...
                                                <div class="erp-filter-item flex-48">
                                                    <div class="input-block mb-0 erp-step-input-block ">
                                                        ...
                                                        <input value="{{$supplier_bank->bank_name}}" name="bank_name[]" type="text" class="form-control" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="erp-filter-item flex-48">
                                                    <div class="input-block mb-0 erp-step-input-block ">
                                                        <label class="col-form-label">Account No </label>
                                                        <input value="{{$supplier_bank->account_no}}" name="account_no[]" type="text" class="form-control " placeholder="">
                                                    </div>
                                                </div>
                                                <div class="erp-filter-item flex-48">
                                                    <div class="input-block mb-0 erp-step-input-block ">
                                                        <label class="col-form-label">Account Name </label>
                                                        <input value="{{$supplier_bank->account_name}}" name="account_name[]" type="text" class="form-control " placeholder="">
                                                    </div>
                                                </div>
                                                <div class="erp-filter-item flex-48">
                                                    <div class="input-block mb-0 erp-step-input-block ">
