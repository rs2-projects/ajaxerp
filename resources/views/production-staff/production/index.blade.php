...
@section('js')
    <script>
        ...
        function getData(){
            getPaginatedListData("{{ route('production-staff.production.production.filtered') }}", "#ajax-data-load", filterData);
        }
        ...
        function getDocunent(id){
            let url = "{{route('production-staff.production.production.get-design-document', ':id')}}";
