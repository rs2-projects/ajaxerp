                        ...
                        @forelse($requisitions as $data)
                            <tr class="erp-tbody-tr">
                                ...
                                <td class="erp-tbody-td text-start">
                                    <a href="{{ route('production-staff.requisition.details', $data->id) }}" class="em-profile-wrap d-flex align-items-center flex-wrap w-100">
                                    ...
                                    <div class="erp-action-t">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{ route('production-staff.requisition.details', $data->id) }}" ><i class="la la-hand-o-right m-r-5"></i> View Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </td>
