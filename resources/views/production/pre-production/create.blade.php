                ...
                <div class="product-general-info-box d-flex flex-wrap">
                    ...
                    <div class="pgib-item flex-25">
                        <div class="input-block erp-step-input-block mb-0">
                            ...
                            <input class="form-control " type="file" placeholder="" required="">
                        </div>
                    </div>
                        ...
                        <div class="production-machine-selection-wrapper d-flex flex-wrap">
                            <div class="pms-item flex-48">
                                <div class="input-block erp-step-input-block mb-0">
                                    ...
                                    <select class="machine-multiselect" multiple="multiple" required>
                                ...
                                <div class="pms-item-wrapper d-flex flex-wrap align-items-end" v-for="(materialSection, materialIndex) in process.materialSections" :key="materialIndex">
                                    <div class="pms-item flex-32">
                                        <div class="input-block erp-step-input-block mb-0">
                                            ...
                                            <select class="select select-step" onchange="categoryChangeOutside(this)">
                                    ...
                                    <div class="pms-item flex-32">
                                        <div class="input-block erp-step-input-block mb-0">
                                            ...
                                            <select class="select select-step material-product" >
                                                <option value="">Select Matarial</option>
                                            </select>
                                        </div>
                                    </div>
...
@section('js')
    <script>
        ...
        var vueApp = createApp({
            ...
            computed: {
                // previousProcessOptions() {
                //     let arr= Array.from({ length: this.index }, (_, i) => i + 1);
                //     console.log(arr)
                // }
            },
            methods: {
                ...
                getMaterialProducts(categoryId) {
                    let url = "{{route('production.pre-production.get-material-products', ':id')}}";
                    url = url.replace(':id', categoryId);
                    try {
                       const response =  axios.get(url);
                       this.$set(this.processes[index].materialSections, 0, response.data);
        ...
        function categoryChangeOutside(select) {
            let cat = $(select).val();
            vueApp.getMaterialProducts(cat);
            console.log(select);
        }
    </script>
@endsection
