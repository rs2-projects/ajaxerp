<form action="{{ route('sales.invoice.make-payment-submit',$invoice->id) }}" id="makePaymentFormSubmit" method="post" enctype="multipart/form-data">
    @csrf
                ...
                <div class="erp-filter-item-wrapper filter-row d-flex flex-wrap align-items-center justify-content-between mb-3 ">
                    <div class="erp-filter-item flex-48">
                        <div class="input-block erp-step-input-block mb-0">
                            ...
                            <input type="number" step="any" class="form-control" required min="0.01" max="{{ $invoice->due_amount }}" value="{{ $invoice->due_amount }}" name="amount">
                        </div>
                    </div>
                    <div class="erp-filter-item flex-48">
                        <div class="input-block erp-step-input-block mb-0">
