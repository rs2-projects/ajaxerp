<!-- Add Geo Modal -->
<div id="add_geo_location_modal" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body erp-modal-body">
                <form action="{{ route('settings.geo-location.store') }}" id="geoLocationStoreForm" method="post">
                    @csrf
                        ...
                        <div class="input-block erp-step-input-block mb-2 text-center">
                            <div class="checkbox">
                                <label class="col-form-label">
                                    <input type="checkbox" name="is_default" value="1"> Make it Default
                                </label>
                            </div>
                        </div>
