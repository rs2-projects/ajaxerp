            ...
            <div class="erp-main-filter-wrapper d-flex justify-content-center ">
                <div class="erp-add-em-step-wrapper bg-card flex-100">
                    <div class="erp-step-content-wrapper">
                        <div id="reg-employee">
                            <form action="{{ route('settings.salary-type.update', $item->id) }}" id="salaryTypeEditForm" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="erp-filter-item-wrapper filter-row d-flex flex-wrap align-items-center justify-content-between mb-4">
                                            ...
                                            <div class="erp-filter-item flex-48">
                                                <div class="input-block mb-0 erp-step-input-block">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ $item->title }}" name="title" placeholder="Title" required>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            $("#salaryTypeEditForm").on('submit', function (e) {
                var self = this;
                e.preventDefault();
