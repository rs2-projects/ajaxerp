        ...
        <tbody class="erp-tbody">
            @foreach($terminationTypes as $item)
                <tr class="erp-tbody-tr">
                    ...
                    <td class="erp-tbody-td">
                        <h4 class="text-start d-table-title">{{ $item->name??'N/A' }} </h4>
                    </td>
                        ...
                        <div class="erp-action-t">
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item"href="javascript:void(0)" onclick="deleteAjax('{{ route('settings.termination-type.delete',$item->id) }}', function (res) { getData(); showSuccessAlert(res.message); })"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
...
{{ $terminationTypes->links('vendor.pagination.common_ajax_pagination') }}
