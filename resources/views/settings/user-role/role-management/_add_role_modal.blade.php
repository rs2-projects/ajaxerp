<!-- Add Category Modal -->
<div id="addRoleModal" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form action="{{ route('settings.role-management.store') }}" id="roleStoreForm" method="POST">
            @csrf
                    ...
                    <div class="erp-modal-body-content">
                        ...
                        <div class="input-block erp-step-input-block mb-2">
                            <label class="col-form-label">
                                <input type="checkbox" name="is_default" value="1"> <span class="ms-1">Is it Default</span>
                            </label>
                        </div>
