...
{{--                                <a class="dropdown-item" href="javascript:void(0)" onclick="editItem({{$userLeave->id}})"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>--}}
                                <a class="dropdown-item" href="javascript:void(0)" onclick="deleteAjax('{{ route('user.leaves.delete',$userLeave->id) }}', 'reloadAjaxGetData') "><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
                            @endif
                        </div>
                    </div>
                </div>
